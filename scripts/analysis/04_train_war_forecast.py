...
Output:
    ...
    data/analysis/war_predictions.csv - Predictions
    data/analysis/forecast_evaluation.txt - Evaluation report
"""
...
PREDICTIONS_DIR = DATA_DIR / "analysis" / "predictions"


def load_features():
    """Load feature matrix."""
    features_path = JOINED_DIR / "auction_features_train.csv"
...
def save_predictions(df, y_pred, model, imputer, feature_cols):
    ...
    output_path = PREDICTIONS_DIR / "war_predictions.csv"
...
def generate_evaluation_report(train_metrics, val_metrics, test_metrics, cv_df, importance_df):
    ...
    report_path = PREDICTIONS_DIR / "forecast_evaluation.txt"
