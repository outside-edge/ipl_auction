...
def load_data():
    ...
    bbb_path = DATA_DIR / "kaggle/ipl-dataset/csv/Ball_By_Ball_Match_Data.csv"
    match_path = DATA_DIR / "kaggle/ipl-dataset/csv/Match_Info.csv"
...
def main():
    ...
    output_path = DATA_DIR / "player_season_stats.csv"
