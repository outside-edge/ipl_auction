...
def calculate_premiums(predictions_df, price_model):
    ...
    predictions_df["is_mega_auction"] = 0  # 2026 is mini auction
...
def main():
    ...
    if model is None:
        ...
        class SimpleLagModel:
            def predict(self, X):
                return X[:, 0]  # Just return first feature (ipl_war_lag1)
...
- Uses T20I data to inform predictions for players with international experience
- Forward-looking WAR forecast instead of simple lagged WAR
