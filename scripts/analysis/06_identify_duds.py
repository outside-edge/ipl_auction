...
from utils import adjust_prices_for_inflation
...
def load_data():
    ...
    auction = pd.read_csv(JOINED_DIR / "auction_with_performance.csv")
    auction = adjust_prices_for_inflation(auction)
    war = pd.read_csv(PERF_DIR / "player_season_war.csv")
