...
IPL_JSON_DIR = SOURCES_DIR / "kaggle" / "ipl-dataset" / "json" / "ipl_match"
...
def build_player_master(matches_df, unmatched_ipl_df, t20i_registry):
    ...
    t20i_ids = set(t20i_registry["cricsheet_id"])
...
def main():
    ...
    player_master = build_player_master(matches_df, unmatched_df, t20i_registry)
    ...
    output_path = JOINED_DIR / "player_master.csv"
