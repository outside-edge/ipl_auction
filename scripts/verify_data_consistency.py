...
def verify_2022_sources():
    ...
    sold_path = DATA_DIR / "2022 Auction/IPL_2022_Sold_Players.csv"
    full_path = DATA_DIR / "2022 Auction/IPL_Auction_2022_FullList.csv"
...
def verify_year_completeness():
    ...
    auction_path = DATA_DIR / "auction_all_years.csv"
...
def generate_report(all_issues):
    ...
    report_path = ANALYSIS_DIR / "verification_report.md"
